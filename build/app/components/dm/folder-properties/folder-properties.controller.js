(function() {
	...
	function FolderPropertiesCtrl($scope, $timeout, DmService){
		let folderPropertyVm = this;

        folderPropertyVm.selectOptions = {
            dataTextField: "name",
            dataValueField: "id",
            ...
            dataBound: function(e) {
                ...
                $timeout(() => {
                    folderPropertyVm.selectedOptions = e.sender.dataSource._pristineData.filter((res) => {
                        return res.isParent;
                    });
                });
    ...
    angular.module('myApp')
        .controller('FolderPropertiesCtrl', FolderPropertiesCtrl);
})();
